...
export const canisterId = process.env.COUNTER_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Counter_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Counter_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Counter_frontend.did.js")._SERVICE>}
 */
export const Counter_frontend = createActor(canisterId);
