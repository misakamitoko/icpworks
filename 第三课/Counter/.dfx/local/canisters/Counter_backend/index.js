...
export const canisterId = process.env.COUNTER_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Counter_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Counter_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Counter_backend.did.js")._SERVICE>}
 */
export const Counter_backend = createActor(canisterId);
